import { IonButton, IonButtons, IonContent, IonHeader, IonLabel, IonList, IonSearchbar, IonText, IonTitle, IonToolbar } from "@ionic/react";
  ...
  return (
    <>
      ...
      <IonContent className="ion-padding">
        ...
        <IonSearchbar placeholder="Поиск по турам" ref={inputQuery} debounce={300} onIonChange={(ev) => handleChange(ev)}></IonSearchbar>

        {
          ...
          <CurrencyInput suffix="₽" decimalsLimit={2} value={0}></CurrencyInput>

          <IonLabel position="stacked" >Кол-во человек</IonLabel>
          <CurrencyInput suffix="₽" decimalsLimit={2} value={0}></CurrencyInput>
