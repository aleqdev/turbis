...
export function PatchTourOrderPaymentTypeModal(
  {onDismiss}: AuthProps & {
...
export const PatchTourOrderPaymentTypeModalController: React.FC = () => {
  const auth = useAppSelector(state => state.auth);
  const dispatch = useAppDispatch();
  
  const [present, dismiss] = useIonModal(PatchTourOrderPaymentTypeModal, {
