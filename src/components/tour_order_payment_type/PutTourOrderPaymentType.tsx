...
export function PutTourOrderPaymentTypeModal(
  {onDismiss}: AuthProps & {
...
export const PutTourOrderPaymentTypeModalController: React.FC = () => {
  const auth = useAppSelector(state => state.auth);
  const dispatch = useAppDispatch();
  
  const [present, dismiss] = useIonModal(PutTourOrderPaymentTypeModal, {
